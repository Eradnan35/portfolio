            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:adnan.kakar@example.com" className="text-zinc-400 hover:text-accent transition-colors">adnan.kakar@example.com</a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+1234567890" className="text-zinc-400 hover:text-accent transition-colors">+1 (234) 567-890</a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-400">City, Country</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button 
                ...
                className="w-full bg-accent text-accent-foreground font-semibold rounded-lg px-4 py-3 hover:bg-accent/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
